	...
	<div class="letter-container">
		...
		{:else}
			<div class="family-description kr">
				<p>
					김경윤<span class="name-divider">{@html nameDivider}</span> 김수현
					<span class="son">의 아들</span>김유석
				</p>
				<p>
					김찬훈<span class="name-divider">{@html nameDivider}</span> 안현아<span class="daughter"
						>의 딸</span
					>김유진
				</p>
			</div>
